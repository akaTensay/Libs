...
function limit(v, min, max) -- Îãðàíè÷åíèå äèíàìè÷åñêîãî çíà÷åíèÿ
	min = min or 0.0
	max = max or 1.0
...
function isPlaceHovered(a, b) -- Ïðîâåðêà íàõîäèòñÿ ëè êóðñîð â óêàçàííîé îáëàñòè
...
function getContrastColor(bg_col, col_1, col_2) -- Ïîëó÷åíèå öâåòà òåêñòà â çàâèñèìîñòè îò ôîíà
...
function set_alpha(color, alpha) -- Ïîëó÷åíèå öâåòà ñ îïðåäåë¸ííîé ïðîçðà÷íîñòüþ
...
M.Picture = function(str_id, image, size, mult, hint)
	hint = hint or u8'Óâåëè÷èòü èçîáðàæåíèå'
